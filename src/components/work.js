			...
			modules: [
				{
					...
					state: "Finished",
					description:
						"User module is responsible for user authentication and registration",
				},
				{
					id: "2",
					...
					state: "Finished",
					description:
						"Categories module is responsible for managing categories of the business",
				},
				{
					id: "3",
					...
					state: "Finished",
					description:
						"Products module is responsible for managing products of the business",
				},
				{
					id: "4",
					title: "Filter Module",
					state: "Finished",
					description:
						"Filter module is responsible for filtering products",
				},
				{
					id: "5",
					title: "Image Module",
					state: "Finished",
					description:
						"Integration with Cloudinary for uploading images",
				},
				{
					id: "6",
					title: "Cart Module",
					state: "In Progress",
					description:
						"Cart module is responsible for managing cart of the user",
				},
				{
					id: "7",
					...
					state: "Backlog",
					description:
						"Payment module is responsible for managing payments",
				},
				{
					id: "8",
					title: "Orders Module",
					state: "Backlog",
					description:
						"Orders module is responsible for managing orders of the user",
				},
				{
					id: "9",
					...
					state: "Backlog",
					description:
						"Reviews module is responsible for managing reviews of the user",
				},
				{
					id: "10",
					...
					state: "Backlog",
					description:
						"Notifications module is responsible for managing notifications of the user",
				},
			],
		},
		{
			...
			>
				...
				<Flex direction={"column"} bg={"blackAlpha.500"} py={10} px={7}>
					...
					<Box textAlign={{ base: "start", md: "end" }} zIndex={9}>
						<Link
							href="https://github.com/FrancoCarrizoDev/ecomerce"
							isExternal
						...
						<Link
							href="https://github.com/FrancoCarrizoDev/ecomerce-back"
							isExternal
							title="Go to application"
							className="work-link"
							pl={"3"}
